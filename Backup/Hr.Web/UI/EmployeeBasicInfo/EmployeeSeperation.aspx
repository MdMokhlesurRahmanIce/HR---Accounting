<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true"
    CodeBehind="EmployeeSeperation.aspx.cs" Inherits="Hr.Web.UI.EmployeeBasicInfo.EmployeeSeperation" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="chpInfHead" runat="server">
    <script src="<%= ResolveUrl("~/gridscripts/grdSeparationInfo.js") %> " type="text/javascript"></script>
    <style type="text/css">
        ...
        <div class="form-details">
            <div style="width: 28%; float: left">
                ...
                <div class="lblAndTxtStyle" style="width: 99%; float: left">
                    ...
                    <div class="div182Px">
                        <asp:DropDownList ID="ddlCause" runat="server" CssClass="drpwidth180px">
                        </asp:DropDownList>
                    </div>
                </div>
                <div class="lblAndTxtStyle" style="width: 99%; float: left">
                    <div class="divlblwidth100px bglbl">
                        <a>Additional Remarks</a>
                    </div>
                     <div class="div80Px">
                        <asp:TextBox ID="txtRemarks" runat="server" CssClass="drpwidth180px" MaxLength="100"></asp:TextBox>
                    </div>
                ...
                <div class="lblAndTxtStyle" style="width: 99%; float: left">
                    ...
                    <div class="div182Px">
                        <asp:DropDownList ID="ddlAction" runat="server" CssClass="drpwidth180px">
                        </asp:DropDownList>
                    </div>
                </div>
                <div class="lblAndTxtStyle" style="width: 99%; float: left">
                    <div class="divlblwidth100px bglbl">
                     ...
                     <div class="div80Px">
                        <asp:TextBox ID="txtEffectiveDate" runat="server" CssClass="drpwidth180px" MaxLength="100"></asp:TextBox>
                    </div>
                ...
                <div class="lblAndTxtStyle" style="width: 99%; float: left">
                    ...
                    <div class="div80Px">
                        <asp:TextBox ID="txtNote" runat="server" CssClass="drpwidth180px" MaxLength="100"></asp:TextBox>
                    </div>
                </div>
            ...
            <div id="divTab" style="width: 71%; float: left;" onclick="return divTab_onclick()">
                ...
                <div id="tabOfficialInfo" style="width: 99%" onclick="return divTab_onclick()">
                    <div>
                        <div>
                            <table id="grdSeparation" style="width: 100%; float: left">
                            </table>
                        </div>
                        <div id="grdSeparation_pager">
                        </div>
                    </div>
                </div>
            </div>
